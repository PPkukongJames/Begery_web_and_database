...
<html>
    ...
    <body>
        ...
        <h1 style="font-size: 40px;font-family: 'Itim', cursive;display: inline-block;">&emsp;&emsp;Baguette</h1><br>
        <div>

        <img style="padding: 5px ;background-color: #ffeed4;display: inline-block;" src="home/Baguette.jfif" width="500" height="350" align=left hspace=75>
        </div>
        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <div id="product">
            ราคา&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp80&nbspบาท<br><br>
            สถานะสินค้า<br><br>
            เหลือสินค้าอยู่&emsp;&emsp;<?php echo $NB.' ';?>&nbspชิ้น <br><br>
            <hr>
            <form  action="AddToCart.php" method="get">
            <label for="quantity">จำนวน &emsp;&emsp;:</label>
            <input style="font-size: 20px;font-family: 'Itim', cursive;" type="number" name="NBread" min="1" max="<?php $NB;?>"><br><br>&emsp;&emsp;
